...
# Data load
folder = "./decay_rates/"
d01 = np.genfromtxt("./../../../01/grendel_post_processing/conductivity/decay_rates/final-0.26-data.dat")
c01 = 0.4 
d02 = np.genfromtxt("./../../../03/grendel_post_processing/conductivity/decay_rates/final-0.26-data.dat")
c02 = 0.6 
d03 = np.genfromtxt("./../../../02/grendel_post_processing/conductivity/decay_rates/final-0.26-data.dat")
c03 = 0.8 
...
axlist.plot( d01[:,0] , d01[:,1],'s-', markersize=marksize, fillstyle='none', lw=1, label=r'$\mathrm{A_{max}}=$'+str(c01))
axlist.plot( d02[:,0] , d02[:,1],'o-', markersize=marksize, fillstyle='none', lw=1, label=r'$\mathrm{A_{max}}=$'+str(c02))
axlist.plot( d03[:,0] , d03[:,1],'o-', markersize=marksize, fillstyle='none', lw=1, label=r'$\mathrm{A_{max}}=$'+str(c03))
...
## Customization.
#Axis label
axlist.set_title(r'$\mathrm{\omega= 0.25}$')
